...
namespace gps {
    ...
    void Shader::setDouble(const char* name, double val)
    {
        int location = glGetUniformLocation(this->shaderProgram, name);
        glUniform1d(location, val);
    }

    void Shader::setMat2f(const char* name, glm::mat2 val)
    {
        int location = glGetUniformLocation(this->shaderProgram, name);
        glUniformMatrix2fv(location, 1, GL_FALSE, glm::value_ptr(val));
    }

    void Shader::setMat3f(const char* name, glm::mat3 val)
    {
        int location = glGetUniformLocation(this->shaderProgram, name);
    ...
    void Shader::setVec2f(const char* name, glm::vec2 val)
    {
        int location = glGetUniformLocation(this->shaderProgram, name);
